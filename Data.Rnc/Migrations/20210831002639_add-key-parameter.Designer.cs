...
namespace Data.Rnc.Migrations
{
    ...
    [Migration("20210831002639_add-key-parameter")]
    partial class addkeyparameter
    {
            ...
            modelBuilder.Entity("Domain.Entities.TypeNonCompliance", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreatedAt = new DateTime(2021, 8, 30, 21, 26, 38, 398, DateTimeKind.Local).AddTicks(7195),
                        ...
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreatedAt = new DateTime(2021, 8, 30, 21, 26, 38, 398, DateTimeKind.Local).AddTicks(9478),
                        ...
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreatedAt = new DateTime(2021, 8, 30, 21, 26, 38, 398, DateTimeKind.Local).AddTicks(9609),
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2021, 8, 30, 21, 26, 38, 392, DateTimeKind.Local).AddTicks(1398));
            ...
            modelBuilder.Entity("Domain.Entities.UserAuth", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2021, 8, 30, 21, 26, 38, 382, DateTimeKind.Local).AddTicks(5424));
            ...
            modelBuilder.Entity("Domain.Entities.UserPermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreatedAt = new DateTime(2021, 8, 30, 21, 26, 38, 397, DateTimeKind.Local).AddTicks(9025),
                            Name = "Employee"
                        },
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreatedAt = new DateTime(2021, 8, 30, 21, 26, 38, 398, DateTimeKind.Local).AddTicks(1137),
                            Name = "Supervisor"
                        },
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreatedAt = new DateTime(2021, 8, 30, 21, 26, 38, 398, DateTimeKind.Local).AddTicks(1269),
