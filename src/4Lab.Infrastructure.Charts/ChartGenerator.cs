    ...
    public class ChartGenerator
    {
        ...
        public static void AddPieChart(DocumentCore dc, FloatingLayout chartLayout, Dictionary<string, double> data, bool addLabels = true, string labelSign = null, bool addLegend = true)
        {
            ...
            for (int i = 0; i < pies; i++)
            {
                ...
                if (colorNumber == colors.Count - 1)
                    colorNumber = 0;
                shpPie.Fill.SetSolid(new Color(colors[colorNumber]));
            ...
            if (addLabels)
            {
                ...
                if (addLegend)
                {
                    ...
                    double legendW = chartLayout.Size.Width * 3;
                    double legendH = 40;
                    ...
                    for (int i = 0; i < data.Count; i++)
                    {
                        ...
                        {
                            FontColor = new Color(colors[colorNumber]),
                            FontName = "Wingdings"
                        });
