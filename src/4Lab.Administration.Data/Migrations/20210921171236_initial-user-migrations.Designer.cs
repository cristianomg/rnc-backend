...
namespace _4lab.Administration.Data.Migrations
{
    ...
    [Migration("20210921171236_initial-user-migrations")]
    partial class initialusermigrations
    {
            ...
            modelBuilder.Entity("_4Lab.Administration.Domain.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2021, 9, 21, 14, 12, 36, 579, DateTimeKind.Local).AddTicks(7302));
            ...
            modelBuilder.Entity("_4Lab.Administration.Domain.Models.UserAuth", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2021, 9, 21, 14, 12, 36, 571, DateTimeKind.Local).AddTicks(5763));
            ...
            modelBuilder.Entity("_4Lab.Administration.Domain.Models.UserPermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreatedAt = new DateTime(2021, 9, 21, 14, 12, 36, 587, DateTimeKind.Local).AddTicks(7584),
                            Name = "Employee"
                        },
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreatedAt = new DateTime(2021, 9, 21, 14, 12, 36, 587, DateTimeKind.Local).AddTicks(8418),
                            Name = "Supervisor"
                        },
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreatedAt = new DateTime(2021, 9, 21, 14, 12, 36, 587, DateTimeKind.Local).AddTicks(8927),
