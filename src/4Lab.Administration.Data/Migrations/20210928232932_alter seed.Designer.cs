...
namespace _4lab.Administration.Data.Migrations
{
    ...
    [Migration("20210928232932_alter seed")]
            ...
            modelBuilder.Entity("_4Lab.Administration.Domain.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2021, 9, 28, 20, 29, 31, 648, DateTimeKind.Local).AddTicks(9097));
            ...
            modelBuilder.Entity("_4Lab.Administration.Domain.Models.UserAuth", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2021, 9, 28, 20, 29, 31, 634, DateTimeKind.Local).AddTicks(1752));
            ...
            modelBuilder.Entity("_4Lab.Administration.Domain.Models.UserPermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreatedAt = new DateTime(2021, 9, 28, 20, 29, 31, 668, DateTimeKind.Local).AddTicks(3769),
                            Name = "Employee"
                        },
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreatedAt = new DateTime(2021, 9, 28, 20, 29, 31, 668, DateTimeKind.Local).AddTicks(5712),
                            Name = "ResponsibleFS"
                        },
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreatedAt = new DateTime(2021, 9, 28, 20, 29, 31, 668, DateTimeKind.Local).AddTicks(6345),
                            Name = "ResponsibleT"
                        },
                        new
                        {
                            Id = 4,
                            Active = true,
                            CreatedAt = new DateTime(2021, 9, 28, 20, 29, 31, 668, DateTimeKind.Local).AddTicks(6352),
                            Name = "QualityAnalist"
                        });
                });
