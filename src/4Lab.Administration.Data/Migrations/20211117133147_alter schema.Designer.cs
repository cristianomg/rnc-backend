...
namespace _4lab.Administration.Data.Migrations
{
    ...
    [Migration("20211117133147_alter schema")]
            ...
            modelBuilder.Entity("_4Lab.Administration.Domain.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2021, 11, 17, 10, 31, 46, 593, DateTimeKind.Local).AddTicks(9453));
            ...
            modelBuilder.Entity("_4Lab.Administration.Domain.Models.UserAuth", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2021, 11, 17, 10, 31, 46, 588, DateTimeKind.Local).AddTicks(7689));
            ...
            modelBuilder.Entity("_4Lab.Administration.Domain.Models.UserPermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreatedAt = new DateTime(2021, 11, 17, 10, 31, 46, 602, DateTimeKind.Local).AddTicks(5865),
                            IsDeleted = false,
                            Name = "Employee"
                        },
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreatedAt = new DateTime(2021, 11, 17, 10, 31, 46, 602, DateTimeKind.Local).AddTicks(6700),
                            IsDeleted = false,
                            Name = "ResponsibleFS"
                        },
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreatedAt = new DateTime(2021, 11, 17, 10, 31, 46, 602, DateTimeKind.Local).AddTicks(6824),
                            IsDeleted = false,
                            Name = "ResponsibleT"
                        },
                        new
                        {
                            Id = 4,
                            Active = true,
                            CreatedAt = new DateTime(2021, 11, 17, 10, 31, 46, 602, DateTimeKind.Local).AddTicks(6827),
                            IsDeleted = false,
                            Name = "QualityAnalist"
                        });
                });
