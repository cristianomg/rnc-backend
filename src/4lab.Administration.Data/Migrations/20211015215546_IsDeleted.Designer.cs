...
namespace _4lab.Administration.Data.Migrations
{
    ...
    [Migration("20211015215546_IsDeleted")]
            ...
            modelBuilder.Entity("_4Lab.Administration.Domain.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2021, 10, 15, 18, 55, 45, 798, DateTimeKind.Local).AddTicks(1401));
            ...
            modelBuilder.Entity("_4Lab.Administration.Domain.Models.UserAuth", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2021, 10, 15, 18, 55, 45, 789, DateTimeKind.Local).AddTicks(7732));
            ...
            modelBuilder.Entity("_4Lab.Administration.Domain.Models.UserPermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreatedAt = new DateTime(2021, 10, 15, 18, 55, 45, 814, DateTimeKind.Local).AddTicks(7648),
                            IsDeleted = false,
                            Name = "Employee"
                        },
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreatedAt = new DateTime(2021, 10, 15, 18, 55, 45, 814, DateTimeKind.Local).AddTicks(9031),
                            IsDeleted = false,
                            Name = "ResponsibleFS"
                        },
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreatedAt = new DateTime(2021, 10, 15, 18, 55, 45, 814, DateTimeKind.Local).AddTicks(9297),
                            IsDeleted = false,
                            Name = "ResponsibleT"
                        },
                        new
                        {
                            Id = 4,
                            Active = true,
                            CreatedAt = new DateTime(2021, 10, 15, 18, 55, 45, 814, DateTimeKind.Local).AddTicks(9300),
                            IsDeleted = false,
                            Name = "QualityAnalist"
                        });
                });
