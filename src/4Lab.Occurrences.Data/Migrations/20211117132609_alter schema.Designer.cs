...
namespace _4Lab.Occurrences.Data.Migrations
{
    ...
    [Migration("20211117132609_alter schema")]
            ...
            modelBuilder.Entity("_4lab.Occurrences.Domain.Models.TypeOccurrence", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreatedAt = new DateTime(2021, 11, 17, 10, 26, 8, 898, DateTimeKind.Local).AddTicks(8735),
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreatedAt = new DateTime(2021, 11, 17, 10, 26, 8, 902, DateTimeKind.Local).AddTicks(1236),
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreatedAt = new DateTime(2021, 11, 17, 10, 26, 8, 902, DateTimeKind.Local).AddTicks(1771),
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = 4,
                            Active = true,
                            CreatedAt = new DateTime(2021, 11, 17, 10, 26, 8, 902, DateTimeKind.Local).AddTicks(8637),
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = 5,
                            Active = true,
                            CreatedAt = new DateTime(2021, 11, 17, 10, 26, 8, 902, DateTimeKind.Local).AddTicks(8950),
                            IsDeleted = false,
