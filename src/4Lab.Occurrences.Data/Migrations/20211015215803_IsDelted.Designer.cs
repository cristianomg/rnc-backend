...
namespace _4Lab.Occurrences.Data.Migrations
{
    ...
    [Migration("20211015215803_IsDelted")]
    partial class IsDelted
    {
            ...
            modelBuilder.Entity("_4lab.Occurrences.Domain.Models.TypeOccurrence", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreatedAt = new DateTime(2021, 10, 15, 18, 58, 2, 542, DateTimeKind.Local).AddTicks(8932),
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreatedAt = new DateTime(2021, 10, 15, 18, 58, 2, 545, DateTimeKind.Local).AddTicks(4678),
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreatedAt = new DateTime(2021, 10, 15, 18, 58, 2, 545, DateTimeKind.Local).AddTicks(5465),
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = 4,
                            Active = true,
                            CreatedAt = new DateTime(2021, 10, 15, 18, 58, 2, 545, DateTimeKind.Local).AddTicks(5763),
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = 5,
                            Active = true,
                            CreatedAt = new DateTime(2021, 10, 15, 18, 58, 2, 545, DateTimeKind.Local).AddTicks(6031),
                            IsDeleted = false,
