...
namespace _4Lab.Occurrences.Data.Migrations
{
    ...
    [Migration("20211013183345_adicionado campos de data para criação das analises")]
    partial class adicionadocamposdedataparacriaçãodasanalises
    {
            ...
            modelBuilder.Entity("_4lab.Occurrences.Domain.Models.TypeOccurrence", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreatedAt = new DateTime(2021, 10, 13, 15, 33, 44, 526, DateTimeKind.Local).AddTicks(5213),
                        ...
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreatedAt = new DateTime(2021, 10, 13, 15, 33, 44, 532, DateTimeKind.Local).AddTicks(4601),
                        ...
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreatedAt = new DateTime(2021, 10, 13, 15, 33, 44, 532, DateTimeKind.Local).AddTicks(5519),
                        ...
                        new
                        {
                            Id = 4,
                            Active = true,
                            CreatedAt = new DateTime(2021, 10, 13, 15, 33, 44, 532, DateTimeKind.Local).AddTicks(5947),
                        ...
                        new
                        {
                            Id = 5,
                            Active = true,
                            CreatedAt = new DateTime(2021, 10, 13, 15, 33, 44, 532, DateTimeKind.Local).AddTicks(6408),
