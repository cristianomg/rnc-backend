...
namespace _4Lab.Occurrences.Data.Migrations
{
    ...
    [Migration("20210929134026_add VerificationOfEffectiveness")]
    partial class addVerificationOfEffectiveness
    {
            ...
            modelBuilder.Entity("_4lab.Occurrences.Domain.Models.TypeOccurrence", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreatedAt = new DateTime(2021, 9, 29, 10, 40, 25, 0, DateTimeKind.Local).AddTicks(2364),
                        ...
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreatedAt = new DateTime(2021, 9, 29, 10, 40, 25, 8, DateTimeKind.Local).AddTicks(26),
                        ...
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreatedAt = new DateTime(2021, 9, 29, 10, 40, 25, 8, DateTimeKind.Local).AddTicks(1290),
                        ...
                        new
                        {
                            Id = 4,
                            Active = true,
                            CreatedAt = new DateTime(2021, 9, 29, 10, 40, 25, 8, DateTimeKind.Local).AddTicks(1946),
                        ...
                        new
                        {
                            Id = 5,
                            Active = true,
                            CreatedAt = new DateTime(2021, 9, 29, 10, 40, 25, 8, DateTimeKind.Local).AddTicks(2708),
