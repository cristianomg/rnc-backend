...
namespace _4Lab.Occurrences.Data.Migrations
{
    ...
    [Migration("20210928140127_alteração do tipo de ocorrencia")]
    partial class alteraçãodotipodeocorrencia
    {
            ...
            modelBuilder.Entity("_4lab.Occurrences.Domain.Models.TypeOccurrence", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreatedAt = new DateTime(2021, 9, 28, 11, 1, 26, 597, DateTimeKind.Local).AddTicks(5831),
                        ...
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreatedAt = new DateTime(2021, 9, 28, 11, 1, 26, 603, DateTimeKind.Local).AddTicks(8632),
                        ...
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreatedAt = new DateTime(2021, 9, 28, 11, 1, 26, 603, DateTimeKind.Local).AddTicks(9824),
                        ...
                        new
                        {
                            Id = 4,
                            Active = true,
                            CreatedAt = new DateTime(2021, 9, 28, 11, 1, 26, 604, DateTimeKind.Local).AddTicks(578),
                        ...
                        new
                        {
                            Id = 5,
                            Active = true,
                            CreatedAt = new DateTime(2021, 9, 28, 11, 1, 26, 604, DateTimeKind.Local).AddTicks(1231),
